...
void GazeboSwashplatePlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
  ...
  motor_sub_ = node_handle_->Subscribe<mav_msgs::msgs::MotorSpeed>("~/" + model_->GetName() + motor_test_sub_topic_, &GazeboSwashplatePlugin::testProto, this);
  */
  ...
  motor_failure_sub_ = node_handle_->Subscribe<msgs::Int>(motor_failure_sub_topic_, &GazeboSwashplatePlugin::MotorFailureCallback, this);
  // FIXME: Commented out to prevent warnings about queue limit reached.
...
// Protobuf test
/*
void GazeboSwashplatePlugin::testProto(MotorSpeedPtr &msg) {
